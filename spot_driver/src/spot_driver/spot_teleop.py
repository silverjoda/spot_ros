...
class SpotTeleop:
    ...
    def process_joy_and_publish(self, joy_data):
        ...
        lin_x=joy_data.axes[1] * self.vel_x_scalar
        lin_y=joy_data.axes[0] * self.vel_y_scalar
        ang_z=joy_data.axes[3] * self.ang_z_scalar
        ...
        if joy_data.buttons[0]:
            allow_stance_change=time.time() - self.latest_stance_timestamp > 0.2
    ...
    def set_spot_stance(self, stance_string):
        ...
        try:
            ...
            rospy.logerr("Spot teleop: Timeout while waiting for {} service: {}".format(
                stance_string, e))
        ...
        try:
            ...
            rospy.loginfo(
                "Spot teleop: Politely asking spot to {}".format(stance_string))
        except rospy.ServiceException as e:
            rospy.logwarn(
                "Spot teleop: Setting {} failed, err: {}".format(stance_string, e))
            return TriggerResponse(success=False)
        return res
    ...
    def set_stairs_mode(self):
        ...
        try:
            ...
            rospy.logerr(
                "Spot teleop: Timeout while waiting for stairs_mode service: {}".format(e))
            return False
        ...
        try:
            ...
            rospy.loginfo(
                "Spot teleop: Switching stairs mode to {}".format(self.stairs_mode))
        except rospy.ServiceException as e:
            rospy.logwarn("Spot teleop: Switching stairs mode to {} failed, err: {}".format(
                self.stairs_mode, e))
            return False
        return res
    ...
    def power_on(self):
        ...
        try:
            ...
            rospy.logerr(
                "Spot teleop: Timeout while waiting for power_on service: {}".format(e))
            return False
        ...
        try:
            ...
            res=service_proxy(TriggerRequest())
            rospy.loginfo(
                "Spot teleop: Attempt to power on: {}.  Is the red button pressed?".format(res))
        except rospy.ServiceException as e:
            rospy.logwarn(
                "Spot teleop: Attempt to power on failed, err: {}".format(e))
            return False
        return res
    ...
    def power_off(self):
        ...
        try:
            ...
            rospy.logwarn(
                "Spot teleop: Attempt to power off failed, err: {}".format(e))
            return False
        return res


if __name__ == "__main__":
    spotteleop=SpotTeleop()
    spotteleop.loop()
